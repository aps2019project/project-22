...
public class MakeMinions {
    public void make() {
        ...
        minions[0] = new Minion(1, "kamandare fars", 300, 2, 6, 4, "ranged", 7, "not");
        minions[1] = new Minion(2, "shamshirzane fars", 400, 2, 6, 4, "melee", -1, "On Attack");
        minions[2] = new Minion(3, "neyzedare fars", 500, 1, 5, 3, "hibrid", 3, "not");
        minions[3] = new Minion(4, "asbsavare fars", 200, 4, 10, 6, "melee", -1, "not");
        minions[4] = new Minion(5, "pahlevane fars", 600, 9, 24, 6, "melee", -1, "On Attack");
        minions[5] = new Minion(6, "sepahsalare fars", 800, 7, 12, 4, "melee", -1, "combo");
        minions[6] = new Minion(7, "kamandare turani", 500, 1, 3, 4, "ranged", 5, "not");
        minions[7] = new Minion(8, "qolab sangdare turani", 600, 1, 4, 2, "ranged", 7, "not");
        minions[8] = new Minion(9, "neyzedare turani", 600, 1, 4, 4, "hybrid", 3, "not");
        minions[9] = new Minion(10, "jasuse turani", 700, 4, 6, 6, "melee", -1, "On Attack");
        minions[10] = new Minion(11, "gorzdare turani", 450, 2, 3, 10, "melee", -1, "not");
        minions[11] = new Minion(12, "shahzade ye turani", 800, 6, 6, 10, "melee", -1, "combo");
        minions[12] = new Minion(13, "div siah", 300, 9, 14, 10, "hybrid", 7, "not");
        minions[13] = new Minion(14, "qule sangandaz", 300, 9, 12, 12, "ranged", 7, "not");
        minions[14] = new Minion(15, "oqab", 200, 2, 0, 2, "ranged", 3, "passive");
        minions[15] = new Minion(16, "dive gorazsavar", 300, 6, 16, 8, "melee", -1, "not");
