...
public class MakeMinions {
    public  static void make() {
        ...
        minions[0] = new Minion(1, "kamandareFars", 300, 2, 6, 4,
                "ranged", 7, "not","Nothing" );
        minions[1] = new Minion(2, "shamshirzaneFars", 400, 2, 6, 4,
                "melee", -1, "On Attack","stun power when attack");
        minions[2] = new Minion(3, "neyzedareFars", 500, 1, 5, 3,
                "hibrid", 3, "not","Nothing");
        minions[3] = new Minion(4, "asbsavareFars", 200, 4, 10, 6,
                "melee", -1, "not","Nothing");
        minions[4] = new Minion(5, "pahlevaneFars", 600, 9, 24, 6,
                "melee", -1, "On Attack","5 unit more for attack power");
        minions[5] = new Minion(6, "sepahsalareFars", 800, 7, 12, 4,
                "melee", -1, "combo","Combo");
        minions[6] = new Minion(7, "kamandareTurani", 500, 1, 3, 4,
                "ranged", 5, "not","Nothing");
        minions[7] = new Minion(8, "qolabSangdareTurani", 600, 1, 4, 2,
                "ranged", 7, "not","Nothing");
        minions[8] = new Minion(9, "neyzedareTurani", 600, 1, 4, 4,
                "hybrid", 3, "not","Nothing");
        minions[9] = new Minion(10, "jasuseTurani", 700, 4, 6, 6,
                "melee", -1, "On Attack","disarm power of enemy and 4 poison");
        minions[10] = new Minion(11, "gorzdareTurani", 450, 2, 3, 10,
                "melee", -1, "not","Nothing");
        minions[11] = new Minion(12, "shahzadeYeTurani", 800, 6, 6, 10,
                "melee", -1, "combo","Combo");
        minions[12] = new Minion(13, "divSiah", 300, 9, 14, 10,
                "hybrid", 7, "not","Nothing");
        minions[13] = new Minion(14, "quleSangandaz", 300, 9, 12, 12,
                "ranged", 7, "not","Nothing");
        minions[14] = new Minion(15, "oqab", 200, 2, 0, 2,
                "ranged", 3, "passive","10 unit power buff with increase your hurt");
        minions[15] = new Minion(16, "DiveGorazsavar", 300, 6, 16,
                8, "melee", -1, "not","Nothing");
        minions[16] = new Minion(17, "quleTakCheshm", 500, 7, 12, 11,
                "hybrid", 3, "On Death","attack to minions of 8 cell by 2 unit power");
        minions[17] = new Minion(18, "mareSammi", 300, 4, 5, 6,
                "ranged", 4, "On Attack","posion power of enemy for 3 turns");
        minions[18] = new Minion(19, "ejdehayeAtashandaz", 250, 5, 9,
                5, "ranged", 4, "not","Nothing");
        minions[19] = new Minion(20, "shireDarandeh", 600, 2, 1, 8,
                "melee", -1, "On Attack","no effect holy buff on");
        minions[20] = new Minion(21, "mareQulpeykar", 500, 8, 14, 7,
                "ranged", 5, "On Spawn","Opposite holy buff");
        minions[21] = new Minion(22, "gorgeSefid", 400, 5, 8, 2,
        ...
        minions[25] = new Minion(26, "jadugareAzam", 550, 6, 6, 6,
                "ranged", 5, "passive",
        ...
        minions[27] = new Minion(28, "gorazeVahshi", 500, 6, 10, 14,
        ...
        minions[33] = new Minion(34, "quleBozorg", 600, 9, 30, 8,
                "hybrid", 2, "not","Nothing");
        minions[34] = new Minion(35, "qule2sar", 550, 4, 10, 4,
                "melee", -1, "On Attack","not apply positive buffs");
        minions[35] = new Minion(36, "naneSarma", 500, 3, 3, 4,
                "ranged", 5, "On Spawn","stun minions of 8 cell around");
        minions[36] = new Minion(37, "fuladZereh", 350, 3, 1, 1,
        ...
        minions[38] = new Minion(39, "shahqul", 600, 5, 10, 4,
                "melee", -1, "combo","Combo");
        minions[39] = new Minion(40, "arjhangDiv", 600, 3, 6, 6,
                "melee", -1, "combo","Combo");
